    ...
    <main id="main-content" className="foundation">
      <article>
        ...
        <p className="eyebrow" style={{ marginTop: 32 }}>
          TradeDocs · Engineering foundation
        </p>
        <h1>
          One shipment.
          <br />
          One connected document set.
        </h1>
        <p className="muted">
          The TradeDocs platform is being built from the production specification. This environment
          is not open for customer use.
        </p>
